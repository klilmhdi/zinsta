...
import 'package:zinsta/src/screens/layout/home/search/search_screen.dart';
            ...
            icon: Stack(
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  radius: 7.8,
                  child: Center(
                    child: AnimatedFlipCounter(value: state is NotificationLoaded ? state.unreadCount : 0, textStyle: TextStyle(fontSize: 8),),
                  ),
                ),
              ],
            ),
