...
class NotificationItem extends StatelessWidget {
  ...
  Widget _buildAvatarWithBadge(BuildContext context, {required String profilePicture}) {
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Icon(_getNotificationIcon(), size: 14, color: Colors.white),
          ),
        ),
      ],
    );
  ...
  void _handleFollowAction(BuildContext context) {
