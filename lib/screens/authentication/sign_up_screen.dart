                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                      containsUsernameNumber ? Colors.green : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ],
                          ),
                          Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                      containsUsername8Length ? Colors.green : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ],
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                      containsPasswordNumber ? Colors.green : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ],
                          ),
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                      containsPassword8Length ? Colors.green : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ],
                          ),
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              setState(() {
                                ...
                                context.read<NotificationBloc>().add(UpdateOneSignalPlayerId(myUser.id));
                              });
                            }
                          },
                          title: "Signup",
